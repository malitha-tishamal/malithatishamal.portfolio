...
const SocialSignUp: React.FC<SocialSignUpProps> = ({ onSuccess, onError }) => {
    ...
    <>
      <div className="flex gap-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-solid hover:bg-stroke border-stroke p-3.5 text-dark duration-200 ease-in dark:border-dark_border dark:text-white dark:hover:bg-primary/10 hover:bg-primary/10! disabled:opacity-60 cursor-pointer"
        >
        ...
        <div className="relative flex-1">
          ...
          <span className="absolute -top-2 -right-1 px-1.5 py-0.5 rounded-full text-[9px] font-bold bg-amber-500 text-white leading-none">
            Soon
          </span>
        </div>
      </div>
