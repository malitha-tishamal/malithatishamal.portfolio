...
const Hero = () => {
  ...
  // Social Links List with Default Brand Colors
  const socialLinks = [
    {
      id: 'linkedin',
      name: 'LinkedIn',
      ...
      baseClass: 'bg-[#0A66C2]/10 text-[#0A66C2] border-[#0A66C2]/30 hover:bg-[#0A66C2] hover:text-white hover:border-[#0A66C2] hover:shadow-lg hover:shadow-[#0A66C2]/25',
    },
    {
      id: 'github',
      name: 'GitHub',
      ...
      baseClass: 'bg-gray-900/10 text-gray-900 dark:bg-white/10 dark:text-white border-gray-900/20 dark:border-white/20 hover:bg-gray-950 hover:text-white dark:hover:bg-white dark:hover:text-black hover:shadow-lg',
    },
    {
      id: 'instagram',
      name: 'Instagram',
      ...
      baseClass: 'bg-pink-500/10 text-[#E1306C] border-pink-500/30 hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:text-white hover:border-transparent hover:shadow-lg hover:shadow-pink-500/25',
    },
    {
      id: 'facebook',
      name: 'Facebook',
      ...
      baseClass: 'bg-[#1877F2]/10 text-[#1877F2] border-[#1877F2]/30 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] hover:shadow-lg hover:shadow-[#1877F2]/25',
    },
    {
      id: 'twitter',
      name: 'X (Twitter)',
      ...
      baseClass: 'bg-black/10 text-black dark:bg-white/10 dark:text-white border-black/20 dark:border-white/20 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black hover:shadow-lg',
    },
    {
      id: 'whatsapp',
      name: 'WhatsApp',
      ...
      baseClass: 'bg-[#25D366]/10 text-[#25D366] border-[#25D366]/30 hover:bg-[#25D366] hover:text-white hover:border-[#25D366] hover:shadow-lg hover:shadow-[#25D366]/25',
    },
    {
      id: 'youtube',
      name: 'YouTube',
      ...
      baseClass: 'bg-[#FF0000]/10 text-[#FF0000] border-[#FF0000]/30 hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] hover:shadow-lg hover:shadow-[#FF0000]/25',
    },
