  ...
  return (
    <section className='relative md:pt-44 pt-28 bg-white dark:bg-darklight bg-cover text-white'>
      <div className='container mx-auto max-w-6xl px-4 grid grid-cols-12 gap-4 relative z-10'>
        ...
        <div
          className="md:col-span-6 col-span-12 relative flex items-center justify-center before:absolute before:content-[''] before:bg-[url('/images/hero/line-leyar.svg')] before:bg-no-repeat before:left-1/2 before:top-0 before:h-24 before:w-52 before:-z-10 before:translate-x-70% before:-translate-y-40% lg:before:inline-block before:hidden after:absolute after:content-[''] after:bg-[url('/images/hero/round-leyar.svg')] after:bg-no-repeat xl:after:inline-block after:hidden after:left-0 after:bottom-0 after:h-6.25 after:w-6.25 after:-z-10 after:-translate-x-1/2 after:translate-y-1/2"
          data-aos='fade-left'
          data-aos-delay='200'
          data-aos-duration='1000'>
          <Image
            src={getImgPath('/images/hero/malitha-hero.jpg')}
            alt='Malitha Tishamal'
            width={450}
            height={480}
            quality={100}
            priority
            className='rounded-3xl shadow-2xl object-cover max-h-[480px] w-auto border border-white/10'
          />
        </div>
      </div>
    </section>
